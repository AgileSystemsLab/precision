% NSB Wrapper 
% NOTE: For speed, disp() updates and warning messages printed to console
% by the nsb-entropy-code in functions find_nsb_entropy and max_evidence
% have been commented out by me (Leo Wood)
...
conditionvariance = conditionaldS_nsbvec.^2;
varianceofent = dS_nsbwordvec.^2;
MIVariance = varianceofent+conditionvariance(:, :, 2);
MISTD = sqrt(MIVariance);
% Save results
save('NSB_data.mat', ...
    'conditionalentropyvec', 'conditionalS_ml1vec', 'S_nsbwordvec', ...
    'conditionaldS_nsbvec', 'dS_nsbwordvec', 'S_ml1wordvec', ...
    'conditionvariance', 'varianceofent', 'MIVariance', 'MISTD');
