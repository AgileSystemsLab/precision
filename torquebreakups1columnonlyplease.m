function [probdist, torquewordcolumn] = torquebreakups1columnonlyplease(numofbin, torqvec)
...
for y = 1:max(choppedtorquevec1)
    ...
    mask1 = choppedtorquevec1 == y;
    torquewordcolumn(mask1) = y;
    probdist = [probdist, sum(mask1)/length(torquewordcolumn)];
%     value = value+1;
end
end
