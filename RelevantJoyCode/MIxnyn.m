...
% zwsp=[x;y]';
% save('D:\Research_Projects\Summer_2018\Coordination\Code\ContinuousMIEstimation-master\zwspMIxnyn.txt', 'zwsp', '-ASCII');
% 
% % execute C Programm
% mcmd = ['C:\Users\putne\cygwin64\bin\bash.exe --login -c "''/cygdrive/d/Research_Projects/Summer_2018/Coordination/Code/ContinuousMIEstimation-master/kraskovStoegbauerGrassberger/MIxnyn.exe'' ''D:\Research_Projects\Summer_2018\Coordination\Code\ContinuousMIEstimation-master/zwspMIxnyn.txt'' ' num2str(Ndx) ' ' num2str(Ndy) ' ' num2str(N) ' ' num2str(kneig) ];
% [a unout]=system(mcmd);
% miout=str2num(unout);
